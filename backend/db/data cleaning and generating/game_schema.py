...
# team mapping
team_to_id = {"ANA": 197, "ARI": 198, "BOS": 199, "BUF": 200, "CAR": 201, "CBJ": 202, "CGY": 203, "CHI": 204,
              "COL": 205, "DAL": 206, "DET": 207, "EDM": 208, "FLA": 209, "LAK": 210, "MIN": 211, "MTL": 212,
              "NJD": 213, "NSH": 214, "NYI": 215, "NYR": 216, "OTT": 217, "PHI": 218, "PIT": 219, "SEA": 220,
              "SJS": 221, "STL": 222, "TBL": 223, "TOR": 224, "VAN": 225, "VGK": 226, "WPG": 227, "WSH": 228}

# data cleaning
all_game_df = pd.read_csv('all_teams.csv', sep=',', header=0, dtype=str)[
...
for index, row in all_game_df.iterrows():
    ...
    output_string += "\t(" + row['gameId'] + ", " + row['season'] + ", \"" + date + "\", " + str(
        team_to_id[row['playerTeam']]) + ", " + str(team_to_id[row['opposingTeam']]) + "),\n"
